...
export default function MainModal({name, isvisible, onClose, children }) {
    ...
    return (
        <div className='fixed inset-0 z-[1000] bg-black bg-opacity-25  flex justify-center top-0 items-center '>
            <div className='w-1/2 flex flex-col rounded bg-white animate-slide-in-from-top'>
